...
public class AllServlet extends HttpServlet {
    private static String ALL_FILE_VIEW_PATH = "F:\\ComputerProgramming\\GitHubRepoSoftUniTasks\\Software-Engineering\\JavaWeb\\Basic\\02. Introduction to Java EE\\WestCompassDealerShop\\src\\main\\webapp\\views\\all.html";
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        String html = fileUtil.readFile(ALL_FILE_VIEW_PATH);
