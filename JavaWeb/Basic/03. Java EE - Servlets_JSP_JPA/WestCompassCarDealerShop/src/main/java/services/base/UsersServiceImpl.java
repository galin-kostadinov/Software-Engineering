...
public class UsersServiceImpl implements UserService {
    ...
    @Inject
    public UsersServiceImpl(EntityManager entityManager, HashingService hashingService, ModelMapper mapper, UsersValidationService usersValidationService) {
    ...
    public void register(String username, String email, String password, String confirmPassword) throws Exception {
        ...
        User user = new User(username, email, hashingService.hash(password));
