...
public class SaleServiceImpl implements SaleService {
    ...
    @Override
    public SaleWithCarCustomerDiscountPriceViewRootDto getAllTotalSalesByCustomer() {
        List<SaleWithCarCustomerDiscountPriceViewDto> dtos = this.saleRepository
                .findAll()
                .stream()
                .map(s -> {
        ...
        return new SaleWithCarCustomerDiscountPriceViewRootDto(dtos);
    }
}
