...
import homework.productsshop.domain.dto.view.CategorySpecificationViewDto;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public CategorySpecificationViewRootDto getCategoriesSpecification() {
        List<Object[]> categoriesSpecification = this.categoryRepository.getCategoriesSpecification();

        List<CategorySpecificationViewDto> categorySpecificationDtos = new ArrayList<>();

        for (Object[] object : categoriesSpecification) {
            CategorySpecificationViewDto categorySpecificationDto =
                    new CategorySpecificationViewDto(object[0].toString(),
        ...
        return new CategorySpecificationViewRootDto(categorySpecificationDtos);
    }
}
