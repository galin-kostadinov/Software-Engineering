...
import homework.productsshop.domain.dto.view.ProductInRangeViewDto;
...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public ProductInRangeViewRootDto getAllProductInRangeWithoutBuyer(BigDecimal lowestPrice, BigDecimal highestPrice) {
        ...
        List<ProductInRangeViewDto> productInRangeDtos = new ArrayList<>();

        for (Product productEntity : productEntities) {
            ProductInRangeViewDto productInRangeDto = this.modelMapper.map(productEntity, ProductInRangeViewDto.class);
        ...
        return new ProductInRangeViewRootDto(productInRangeDtos);
    }
