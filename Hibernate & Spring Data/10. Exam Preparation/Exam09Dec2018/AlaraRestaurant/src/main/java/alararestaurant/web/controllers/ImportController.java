...
public class ImportController extends BaseController {
    ...
    public ModelAndView importEmployeesConfirm(@RequestParam("employees") String employees) throws FileNotFoundException {
    ...
    @PostMapping("/items")
    public ModelAndView importItemsConfirm(@RequestParam("items") String items) throws FileNotFoundException {
